...
/**
 * UrlSearch represents the model behind the search form about `\backend\models\Url`.
 */
class UrlSearch extends Model
{
	public $id;
	public $is_active;
	public $type;
	...
	{
		return [
			[['id', 'is_active', 'created_by_entity_id', 'updated_by_entity_id'], 'integer'],
			[['type', 'description', 'create_time', 'update_time'], 'safe'],
		];
	}

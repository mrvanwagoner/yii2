...
class TeamSearch extends Model
{
	...
	{
		return [
			[['id', 'is_active', 'project_id', 'entity_id', 'type_picklist_id', 'has_access', 'is_client', 'is_partner', 'is_sales_rep', 'is_schedule_visible', 'created_by_entity_id', 'updated_by_entity_id'], 'integer'],
			[['type', 'service_status', 'note', 'create_time', 'update_time'], 'safe'],
		];
	}
	...
	public function search($params)
	{
		...
		$this->addCondition($query, 'has_access');

...
<!--<div id="sidebar-left" class="col-lg-2 col-sm-1" style="min-height: 650px;">
								
	<div class="sidebar-nav nav-collapse collapse navbar-collapse">
		<ul class="nav main-menu">
          <li class="active"><a href="/admin/account/"><i class="fa fa-bar-chart-o"></i><span class="hidden-sm text"> Accounts</span></a></li>
          	<li><a href="/admin/address/">Addresses</a></li>
			<li><a class="dropmenu" href="#"><i class="fa fa-eye"></i><span class="hidden-sm text"> UI Features</span> <span class="caret closed"></span></a>
          ...
          <li><a href="/admin/building/">Buildings</a></li>
          <li><a href="/admin/campaign/">Campaigns</a></li>
          <li><a href="/admin/classification/">Classifications</a></li>
          <li><a href="/admin/code/">Codes</a></li>
          <li><a href="/admin/contact/">Contacts</a></li>
          <li><a href="/admin/correspondence/">Correspondence</a></li>
          <li><a href="/admin/document/">Documents</a></li>
          <li><a href="/admin/email/">Email</a></li>
          <li><a href="/admin/entity/">Entities</a></li>
          <li><a href="/admin/phone/">Phone</a></li>
          <li><a href="/admin/picklist/">Picklist</a></li>
          <li><a href="/admin/project/">Projects</a></li>
          <li><a href="/admin/project-team/">Project Team</a></li>
          <li><a href="/admin/rate/">Rates</a></li>
          <li><a href="/admin/relationship/">Relationships</a></li>
...
<!--<div id="sidebar-left" class="col-lg-2 col-sm-1" style="min-height: 650px;">
				...
				<div class="sidebar-nav nav-collapse collapse navbar-collapse">
					<ul class="nav main-menu">
						<li class="active"><a href="index.html" class=""><i class="fa fa-bar-chart-o"></i><span class="hidden-sm text"> Dashboard</span></a></li>	
						<li>
						...
						<li><a href="widgets.html" class=""><i class="fa fa-dashboard"></i><span class="hidden-sm text"> Widgets</span></a></li>
						<li>
						...
						<li><a href="typography.html" class=""><i class="fa fa-font"></i><span class="hidden-sm text"> Typography</span></a></li>
						<li><a href="gallery.html" class=""><i class="fa fa-picture-o"></i><span class="hidden-sm text"> Gallery</span></a></li>
						<li><a href="table.html" class=""><i class="fa fa-align-justify"></i><span class="hidden-sm text"> Tables</span></a></li>
						<li><a href="calendar.html" class=""><i class="fa fa-calendar"></i><span class="hidden-sm text"> Calendar</span></a></li>
						<li><a href="file-manager.html" class=""><i class="fa fa-folder-open"></i><span class="hidden-sm text"> File Manager</span></a></li>
						<li>
						...
						<li>
							...
							<ul style="display: none;">
								...
								<li>
									...
									<a href="index.html#" id="main-menu-min" class="visible-md visible-lg full"><i class="fa fa-angle-double-left"></i></a>
							</div>
-->
...
<div id="sidebar-left" class="col-lg-3" style="min-height: 650px;">
